      ...
      <section className="bg-gradient-to-r from-purple-600 via-blue-600 to-cyan-500 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/90 max-w-3xl">
            Secure your spot at Tech Innovation Summit 2024
          </p>
        </div>
      </section>
        ...
        {selectedTier && (
          <div className="mt-8 bg-white rounded-2xl p-8 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full px-8 py-4 bg-gradient-to-r from-purple-600 to-cyan-500 text-white rounded-xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 hover:-translate-y-1"
                  >
